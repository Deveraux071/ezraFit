...
import unittest
from body_measurement.code2 import analyze_chessboard, getDistance, pixel_to_distance, getHeadPoint, get_wrist, affine_correct, chess_board_corners, first_sharp_fall
import cv2
import numpy as np
