...
class TestUtils(unittest.TestCase):
    def test_first_sharp_fall(self):
        image1 = cv2.imread('test_images/first.jpg')
    ...
    def test_analyze_chessboard_affline_false(self):
        ...
        image1 = cv2.imread('test_images/final_saket1.jpg')
    ...
    def test_affine_correct_M_not_None(self):
        image1 = cv2.imread('test_images/final_saket2.jpg')
    ...
    def test_get_wrist(self):
        image2 = cv2.imread('test_images/second.jpg')
