This is EzraFit's backend folder, written in Python (Flask). Before running the server, it is best to spin up a virtual environment to preserve the libraries (an versions) used by this app.
